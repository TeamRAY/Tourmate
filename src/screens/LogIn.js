        ...
        <View style={styles.mainContainer}>
            <View style={styles.logoContainer}>
                ...
                <View style={styles.topicContainer}>
                    <Text style={styles.topicBold}>Sign In</Text>
                    <Text style={styles.topicRegular}>Welcome back</Text>
                </View>
            ...
            <View style={styles.proceedBtnContainer}>
                ...
                <View style={globalStyles.alreadyContainer}>
                    <Text style={globalStyles.smallText}>New to Tourmate?</Text>
                    <TouchableOpacity style={globalStyles.button2}>
                        <Text style={globalStyles.button2Text}>Sign Up</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
